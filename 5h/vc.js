...
btnAdd.onclick = function () {
    ...
    xhttp.open('GET', `https://content.googleapis.com/youtube/v3/search?q=${keyword}&type=video&maxResults=50&part=snippet&key=AIzaSyAYvLrGcBx_aN03lbAualphV1ucUzhbNX4`, true);
    xhttp.send();
}
